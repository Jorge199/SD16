...
class gsp_ispClientWeb_clientedit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("id"),'value':(clientInstance?.id)],-1)
printHtmlPart(20)
invokeTag('hiddenField','g',32,['name':("version"),'value':(clientInstance?.version)],-1)
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1381958102780L
