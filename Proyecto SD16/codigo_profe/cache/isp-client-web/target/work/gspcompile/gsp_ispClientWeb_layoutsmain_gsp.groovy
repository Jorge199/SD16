...
class gsp_ispClientWeb_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(9)
expressionOut.print(g.message(code:'servername'))
printHtmlPart(10)
invokeTag('layoutBody','g',36,[:],-1)
printHtmlPart(11)
invokeTag('message','g',39,['code':("spinner.alt"),'default':("Loading&hellip;")],-1)
printHtmlPart(12)
invokeTag('javascript','g',41,['library':("application")],-1)
printHtmlPart(13)
...
public static final long LAST_MODIFIED = 1449173053213L
