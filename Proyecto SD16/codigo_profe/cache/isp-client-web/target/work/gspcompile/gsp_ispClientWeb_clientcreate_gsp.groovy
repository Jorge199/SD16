...
class gsp_ispClientWeb_clientcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',26,['bean':(clientInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(clientInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
public static final long LAST_MODIFIED = 1381958102743L
