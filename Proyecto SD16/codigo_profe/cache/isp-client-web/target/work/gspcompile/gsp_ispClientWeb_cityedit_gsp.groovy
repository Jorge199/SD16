...
class gsp_ispClientWeb_cityedit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("id"),'value':(cityInstance?.id)],-1)
printHtmlPart(20)
invokeTag('hiddenField','g',32,['name':("version"),'value':(cityInstance?.version)],-1)
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1382098018194L
