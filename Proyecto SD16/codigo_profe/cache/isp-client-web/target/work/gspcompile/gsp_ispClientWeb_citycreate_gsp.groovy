...
class gsp_ispClientWeb_citycreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',26,['bean':(cityInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(cityInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
public static final long LAST_MODIFIED = 1382098018180L
